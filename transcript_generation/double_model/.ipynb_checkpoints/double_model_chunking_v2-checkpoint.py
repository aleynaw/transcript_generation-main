...
patient_prompt_path = 'prompts/double_model_prompts/INSTRUCT/patient_prompt_v2.txt'
asst_prompt_path = 'prompts/double_model_prompts/INSTRUCT/assistant_prompt_v6.txt'
...
def interview_gen(patient: dict, output_id: str, out_dir=out_dir, tracking_path=tracking_path):
    ...
    helper.write_list_to_json(conversation, Path(out_dir,out_path + ".json"))
    try:
